    ...
    <div className="p-6 mb-4 border-b border-neutral-50 flex items-center justify-between">
      ...
      >
        ...
        <div className="min-w-0">
          ...
          <p className="text-[10px] uppercase tracking-widest text-[#95134F] font-bold">Coach Portal</p>
        </div>
      </Link>
        ...
        return (
          ...
          >
            ...
            {link.name === 'Schedule' && pendingCheckins > 0 && (
              <span className="ml-auto w-5 h-5 rounded-full bg-[#803a1e] text-white text-[10px] font-bold flex items-center justify-center">
                {pendingCheckins}
              </span>
            )}
          </Link>
