      ...
      <div className="bg-white p-8 lg:p-10 rounded-panel shadow-[0_2px_12px_rgb(0,0,0,0.03)] border border-neutral-100/50 space-y-12">
        ...
        <section className="space-y-6">
          <div>
            ...
            <p className="text-sm text-text-secondary">
              Measurements and training baseline.
            </p>
          </div>
          <div className="space-y-4">
            {heightUnit === 'cm' ? (
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest mb-2 block">
                  Starting Weight ({weightUnitLabel(weightUnit)})
                </label>
                <input
                  type="number"
                  inputMode="decimal"
              ...
              <div>
                <label className="text-[10px] font-bold text-text-secondary uppercase tracking-widest mb-2 block">
                  Current Weight ({weightUnitLabel(weightUnit)})
                </label>
                <input
                  type="number"
                  inputMode="decimal"
        ...
        <section className="space-y-6">
          <div>
            ...
            <p className="text-sm text-text-secondary">
              Daily targets and macro breakdown.
            </p>
          </div>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-6">
        ...
        <section className="space-y-6">
          <div>
            ...
            <p className="text-sm text-text-secondary">
              Cycle information and conditions the client has shared.
            </p>
          </div>
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-neutral-200 rounded-control p-4 focus:outline-none transition-colors text-sm resize-none"
              />
            </div>
          </div>
        </section>
