...
import type { AssessmentCallEmailVariant } from './AssessmentCallVisitorConfirmation';

export type AssessmentCallCoachNotificationProps = {
...
const EYEBROW = 'Assessment call — new booking';
const HEADING = 'A new assessment call.';
const SUBHEAD = 'Here is who booked it and when.';
...
export function AssessmentCallCoachNotification({
  variant = 'with-notes',
...
}: AssessmentCallCoachNotificationProps) {
          ...
          <EmailContainer style={cardStyle} maxWidth={568}>
            ...
            <EmailSection style={reassuranceSectionStyle}>
              <EmailText style={reassuranceTextStyle}>
                Reply to this email to reach her directly.
              </EmailText>
            </EmailSection>
          </EmailContainer>
...
AssessmentCallCoachNotification.PreviewProps = {
  variant: 'with-notes',
} satisfies AssessmentCallCoachNotificationProps;

export default AssessmentCallCoachNotification;
