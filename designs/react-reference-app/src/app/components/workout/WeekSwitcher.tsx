  ...
  return (
    <div className="flex items-center gap-2">
        <button
          ...
          className="inline-flex items-center justify-center size-11 shrink-0 rounded-xl text-neutral-600 hover:text-[#121212] hover:bg-neutral-100 transition-colors disabled:opacity-30 disabled:pointer-events-none"
        >
