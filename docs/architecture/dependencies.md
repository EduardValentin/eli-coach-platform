...
| C17 assessment-calls | C5 ui | 6 | `./primitives` (the booking page, the details form, the confirmation, the unavailable state and `slot-picker.tsx`), `./lib` (`slot-picker.tsx`) and `./calendar` (`slot-calendar.tsx`) |
