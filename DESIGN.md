...
- **My Method typography:** The public My Method section uses `leading-public-my-method-heading` for its main heading and `text-public-my-method-figure-heading` for the graph caption heading. These preserve the prototype's 1.25 heading line-height and 20px / 28px figure heading without leaking one-off typography utilities into the route.
