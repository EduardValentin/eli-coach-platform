...
| C17 assessment-calls | C5 ui | 6 | `./primitives` (the booking page, the details form, the confirmation, the unavailable state and `slot-picker.tsx`), `./lib` (the confirmation and `slot-picker.tsx`) and `./calendar` (`slot-calendar.tsx`) |
...
| E1218 | apps/platform/src/features/accounts/ui/shared/access-denied-page.tsx | packages/ui/src/lib/index.ts | import | yes | no | lateral | present |
...
| E1228 | apps/platform/src/root-error-page.tsx | packages/ui/src/lib/index.ts | import | yes | no | lateral | present |
...
| E1234 | apps/platform/src/surfaces/public-site/pages/pricing.tsx | packages/ui/src/lib/index.ts | import | yes | no | lateral | present |
...
| E1246 | packages/domain/src/coach-availability/coach-availability.ts | packages/domain/src/coach-availability/busy-interval.ts | import | no | no | lateral | present |
...
| E1248 | packages/domain/src/coach-availability/coach-calendar.ts | packages/domain/src/coach-availability/busy-interval.ts | import | no | yes | inward | present |
| E1249 | packages/domain/src/coach-availability/index.ts | packages/domain/src/coach-availability/busy-interval.ts | import | no | yes | inward | present |
...
| E1252 | packages/domain/src/coach-availability/slot-policy.ts | packages/domain/src/coach-availability/busy-interval.ts | import | no | no | lateral | present |
...
| E1191 | apps/platform/src/features/assessment-calls/ui/public/book/booking-confirmation.tsx | packages/ui/src/lib/index.ts | import | yes | no | lateral | present |
