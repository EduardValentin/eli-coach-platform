      ...
      <div className="flex gap-2">
        {options.map((option) => {
          ...
          return (
            <label
              className={cn(
                "flex min-w-0 flex-1 cursor-pointer items-center justify-center rounded-portal-control border py-2 text-body-sm leading-5 font-medium transition-colors has-[:focus-visible]:outline-solid has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-offset-2 has-[:focus-visible]:outline-text-primary",
                {
