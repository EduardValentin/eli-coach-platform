      ...
      {selectedDate && (
        ...
        >
          <div className="flex items-baseline justify-between mb-3">
            <div>
              <p className="text-[10px] font-bold text-[#95134F] uppercase tracking-widest mb-1">Pick a time</p>
            ...
            <button
              ...
              className="lg:hidden text-xs font-semibold text-[#95134F] hover:underline"
            >
              Change date
            </button>
          </div>
                  ...
                  className={`w-full py-3 px-4 rounded-xl text-sm font-medium transition-all duration-200 border ${
                    slot.isBooked
                      ...
                      : selectedTime === slot.time
                        ...
                        : 'bg-white border-[#95134F]/30 text-[#95134F] hover:border-[#95134F] hover:bg-[#95134F]/5'
                  }`}
                >
          ...
          {showMessageField && selectedTime && (
            ...
            >
              <textarea
                ...
                rows={2}
                className="w-full px-3 py-2.5 text-sm border border-neutral-200 rounded-xl focus:outline-none focus:border-[#95134F] bg-neutral-50 resize-none"
              />
            </motion.div>
          )}
        </motion.div>
