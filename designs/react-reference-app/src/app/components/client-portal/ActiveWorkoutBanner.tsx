...
export function ActiveWorkoutBanner() {
  ...
  return (
    <Link
      ...
      className="group relative block mb-5 sm:mb-6 rounded-2xl overflow-hidden bg-[#121212] text-white shadow-sm transition-all hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#95134F] focus-visible:ring-offset-2 focus-visible:ring-offset-[#FAFAFA]"
    >
      <div className="flex items-center gap-3 px-4 py-3 sm:px-5 sm:py-3.5">
        <span className="shrink-0 relative flex items-center justify-center w-10 h-10 rounded-full bg-[#95134F]/20">
          <span
            aria-hidden="true"
            className="absolute inset-0 rounded-full bg-[#95134F]/25 animate-ping [animation-duration:3s] motion-reduce:hidden"
          />
          <Activity size={18} className="relative text-white" aria-hidden="true" />
        </span>
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold uppercase tracking-widest text-[#95134F]">In progress</span>
      ...
      <div className="h-1 w-full bg-white/10" aria-hidden="true">
        <div
          className="h-full bg-[#95134F] transition-all"
