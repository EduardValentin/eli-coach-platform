...
| C17 assessment-calls | C5 ui | 6 | `./primitives` (the booking page, the details form, the confirmation and the unavailable state), `./lib` (the booking page, the details form, the confirmation and `slot-picker.tsx`) and `./calendar` (`slot-calendar.tsx`) |
...
| The call-moment wording (contracts/call-moment.ts: `formatCallMoment`, `formatCallDay`) | C17 only: the two email content builders read `formatCallMoment`, and one browser module, `slot-calendar.tsx`, reads `formatCallDay` for the days' accessible names. The booking page's visible date, time and zone are worded by the feature-private `ui/public/book/call-display.ts`, so since the booking-card rebuild the email and the screen no longer word a call from one source. `Intl`-only, with one `Intl.DateTimeFormat` cached per part and zone for the life of the process | C17 |
...
| E1184 | apps/platform/src/features/assessment-calls/ui/public/book/book-page.tsx | apps/platform/src/features/assessment-calls/ui/public/book/booking-classes.ts | import | no | no | lateral | present |
...
| E1187 | apps/platform/src/features/assessment-calls/ui/public/book/book-page.tsx | packages/ui/src/lib/index.ts | import | yes | no | lateral | present |
...
| E1188 | apps/platform/src/features/assessment-calls/ui/public/book/booking-confirmation.tsx | apps/platform/src/features/assessment-calls/ui/public/book/booking-classes.ts | import | no | no | lateral | present |
| E1189 | apps/platform/src/features/assessment-calls/ui/public/book/booking-confirmation.tsx | apps/platform/src/features/assessment-calls/ui/public/book/call-display.ts | import | no | no | lateral | present |
...
| E1192 | apps/platform/src/features/assessment-calls/ui/public/book/booking-details-form.tsx | apps/platform/src/features/assessment-calls/ui/public/book/booking-classes.ts | import | no | no | lateral | present |
...
| E1194 | apps/platform/src/features/assessment-calls/ui/public/book/booking-details-form.tsx | packages/ui/src/lib/index.ts | import | yes | no | lateral | present |
...
| E1195 | apps/platform/src/features/assessment-calls/ui/public/book/call-overview.tsx | apps/platform/src/features/assessment-calls/ui/public/book/call-display.ts | import | no | no | lateral | present |
...
| E1198 | apps/platform/src/features/assessment-calls/ui/public/book/slot-picker.tsx | apps/platform/src/features/assessment-calls/ui/public/book/call-display.ts | import | no | no | lateral | present |
...
| E1202 | apps/platform/src/features/assessment-calls/ui/public/book/unavailable-slots.tsx | apps/platform/src/features/assessment-calls/ui/public/book/booking-classes.ts | import | no | no | lateral | present |
