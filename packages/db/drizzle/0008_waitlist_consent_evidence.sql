...
ALTER TABLE "app"."waitlist_entries" ADD COLUMN "updated_at" timestamp with time zone NOT NULL;--> statement-breakpoint
CREATE INDEX "waitlist_entries_updated_at_idx" ON "app"."waitlist_entries" USING btree ("updated_at");
