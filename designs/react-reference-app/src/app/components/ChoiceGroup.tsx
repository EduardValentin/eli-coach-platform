...
export function ChoiceOption({
  ...
  return (
    <RadioGroupPrimitive.Item
      className={cn(
        'flex h-[calc(var(--size-control-sm)-6px)] flex-1 items-center justify-center rounded-[calc(var(--radius-field)-3px)] px-3 text-sm font-semibold text-text-secondary whitespace-nowrap outline-none transition-colors hover:text-brand focus-visible:ring-[3px] focus-visible:ring-ring/50 data-[state=checked]:bg-brand data-[state=checked]:text-brand-foreground data-[state=checked]:hover:text-brand-foreground disabled:pointer-events-none disabled:opacity-50',
        className,
      )}
      {...props}
    >
