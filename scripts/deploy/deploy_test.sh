...
# The host directory keeps its historical name: it already holds TEST's published covers.
ASSET_ROOT_HOST="${ASSET_ROOT_HOST:-/srv/store-assets/${APP_NAME}}"
...
require_env POSTGRES_RUNTIME_IMAGE

export POSTGRES_RUNTIME_IMAGE
...
MIGRATION_IMAGE=${MIGRATION_IMAGE}
DESIGN_REFERENCE_IMAGE=${DESIGN_REFERENCE_IMAGE}
ASSET_ROOT_HOST=${ASSET_ROOT_HOST}
EOF
}
...
install -d -m 0770 "${ASSET_ROOT_HOST}"
