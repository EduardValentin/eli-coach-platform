      ...
      {expandedSets && (
        <div className="px-4 pb-4 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 min-h-11 mt-1 rounded-xl border border-dashed border-neutral-200 text-neutral-600 text-xs lg:text-sm font-semibold hover:border-[#C81D6B]/40 hover:text-[#C81D6B] hover:bg-[#C81D6B]/[0.03] transition-colors"
          >
  ...
  return (
    ...
    >
      ...
      <span className={`text-xs lg:text-sm font-bold w-5 text-center shrink-0 ${
        setLog.completed ? 'text-[#00796B]' : 'text-neutral-600'
      }`}>
        {setLog.setNumber}
      </span>
      ...
      <button
        ...
        className={`w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center rounded-full shrink-0 transition-all ${
          setLog.completed
            ...
            : 'bg-neutral-200 text-neutral-600 hover:bg-[#C81D6B] hover:text-white'
        }`}
      >
