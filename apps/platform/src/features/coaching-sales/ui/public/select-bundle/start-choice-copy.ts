export const START_CHOICE_QUESTION =
...
export const WAITING_START_BODY =
  "I keep my full right to withdraw and receive a full refund during those 14 days. My program would start on";

export const START_CHOICE_REQUIRED =
